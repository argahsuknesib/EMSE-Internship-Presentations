...
\begin{frame}
    ...
    \begin{itemize}
        \item Autonomous navigation with SLAM \cite{b2}
        \item A simple .csv log file demonstration.
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item I implemented and got a sort of .csv output. I wish to work on that in future.
    \end{itemize}
\end{frame}
